...
describe('DateRangeSelector', () => {
  ...
  it('1. 기간 탭 버튼 4개가 렌더링되어야 함', () => {
    render(<DateRangeSelector range={defaultRange} onChange={() => {}} mealType="all" onMealTypeChange={() => {}} />);
  ...
  it('2. 7일 탭 클릭 시 from = 6일 전, to = 오늘로 onChange 호출', () => {
    ...
    render(<DateRangeSelector range={{ ...defaultRange, period: '30days' }} onChange={onChange} mealType="all" onMealTypeChange={() => {}} />);
